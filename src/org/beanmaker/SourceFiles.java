...
public class SourceFiles {
    ...
    public static void addCommentAndVersion(final StringBuilder buf) {
        buf.append("// Generated by BeanMaker v6, on ");
    ...
    public static String chopId(final String nameWithId) {
        if (!nameWithId.startsWith(nameWithId))
